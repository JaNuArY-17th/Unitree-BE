...
export class Added3ColsToResources1773911248739 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "resources" ADD "code" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "resources" ADD CONSTRAINT "UQ_b7ab912cd81e4b447e43d45e382" UNIQUE ("code")`,
    );
    await queryRunner.query(
      `ALTER TABLE "resources" ADD "assets_path" character varying`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "resources" DROP COLUMN "assets_path"`,
    );
    await queryRunner.query(
      `ALTER TABLE "resources" DROP CONSTRAINT "UQ_b7ab912cd81e4b447e43d45e382"`,
    );
